      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 50),
            Image.asset(
              isTawjehi ? "assets/images/auth/twjehe.png" : "assets/images/auth/courses.png",
              width: 120,
              height: 120,
            ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    customTextField(text: "تذكرني", size: 16),
                  ],
                ),
                ...
                TextButton(
                  ...
                  child: const Text("نسيت كلمة المرور؟", style: TextStyle(color: Colors.redAccent, fontSize: 16)),
                ),
              ],
            ),
            const SizedBox(height: 10),
            AppButtons.primaryButton(
              text: 'تسجيل الدخول',
              onPressed: () => Navigator.pushNamed(context, AppRoutes.chooseSpecialization),
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: customTextField(text: "أو", size: 18),
                ),
                Expanded(child: Divider(thickness: 1)),
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                customTextField(text: 'ليس لديك حساب؟ ', size: 18),
                TextButton(
                  onPressed: () => Navigator.pushNamed(context, AppRoutes.signup),
                  child: customTextField(text: 'قم بالتسجيل ', size: 18, color: AppColors.blueColor),
                ),
              ],
            ),
          ],
