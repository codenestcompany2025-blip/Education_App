            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  customTextField(text: "اوافق على شروط واحكام وسياسة الخصوصية", size: 16),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  customTextField(text: 'هل لديك حساب؟ ', size: 18),
                  TextButton(
                    onPressed: () {
                      Navigator.pushNamed(context, AppRoutes.login);
                    },
                    child: customTextField(text: 'تسجيل الدخول', size: 18, color: AppColors.blueColor),
                  ),
                ],
              ),
            ],
