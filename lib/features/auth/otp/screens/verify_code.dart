...
class _VerifyCodeState extends State<VerifyCode> {
  ...
  void _verifyCode() {
    ...
    if (code.length == 4) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("✅ تم التحقق من الرمز: $code")));
    } else {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("⚠️ الرجاء إدخال الرمز الكامل")));
    }
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              customTextField(text: 'رمز التحقق', color: Colors.black, size: 25),
              const SizedBox(height: 30),
